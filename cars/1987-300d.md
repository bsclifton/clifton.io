...
Option sheet | [click here](https://www.lastvin.com/vin/1LQyK2rJ5YYe2evaB) (lastvin.com)
...
- Installed european spec headlamps
    - Left headlamp `124-820-01-61` (Automotive Lighting)
    - Left headlamp gasket `124-826-05-80`
    - Right headlamp `124-820-02-61` (Automotive Lighting)
    - Right headlamp gasket `124-826-06-80`
    - Left indicator `124-826-00-43` (Automotive Lighting)
    - Right indicator `124-826-03-43` (Automotive Lighting)
